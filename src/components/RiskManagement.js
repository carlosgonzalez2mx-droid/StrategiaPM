...
const RiskManagement = ({ 
  ...
  // Hook de auditoría
  const { logRiskCreated } = useAuditLog(currentProjectId, useSupabase);

  // Función auxiliar para actualizar campos del riesgo de forma segura
  const updateEditingRisk = (fieldName, value) => {
    setEditingRisk(prev => ({
      ...prev,
      [fieldName]: value
    }));
  ...
  const handleAddRisk = () => {
    setEditingRisk({
      ...
      assumptions: [],
      constraints: [],
      projectId: currentProjectId // Asignar el proyecto actual
    });
    setShowRiskForm(true);
  };

  const handleEditRisk = (risk) => {
    setEditingRisk(Object.assign({}, risk, { projectId: currentProjectId }));
    setShowRiskForm(true);
  };
  ...
  const updateReservesFromMonteCarlo = (monteCarloResults) => {
    ...
    if (currentProject && setProjects) {
      ...
      const updatedProject = {
        ...currentProject,
        contingencyReserve: p80Contingency,
        managementReserve: p95Management,
        monteCarloResults: {
...
📊 Reserva de Contingencia: $${(p80Contingency / 1000).toFixed(1)}K (P80)
📊 Reserva de Gestión: $${(p95Management / 1000).toFixed(1)}K (P95)
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-red-50 to-orange-100 rounded-2xl shadow-lg p-6 mb-6 text-gray-800 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-4xl font-bold mb-2 text-gray-800">Gestión de Riesgos</h1>
                  <p className="text-gray-600 text-lg">Identificación, análisis y respuesta a riesgos del proyecto según PMBOK</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <select
                  ...
                  className="px-4 py-2 rounded-lg bg-white text-gray-800 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500 shadow-sm"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-green-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-green-900">
                  ${(calculateManagementReserve() / 1000).toFixed(0)}K
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateEditingRisk('code', e.target.value)}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateEditingRisk('name', e.target.value)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateEditingRisk('costImpact', parseInt(e.target.value) || 0)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="0"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateEditingRisk('scheduleImpact', parseInt(e.target.value) || 0)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="0"
                      />
                    </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        {showFileManager && (
          <FileManager 
            ...
            onFileUploaded={() => {
              // Archivo de riesgo subido exitosamente desde gestión de riesgos
            }}
          />
        )}
      </div>
