...
const FinancialManagement = ({ 
  ...
  // Estado para gestor de archivos
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold">
                  {editingContract?.id ? 'Editar Contrato' : 'Nuevo Contrato'}
                </h2>
                <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditingContract({
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, number: e.target.value})}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full border rounded px-3 py-2"
                    value={editingContract?.supplier || ''}
                    onChange={(e) => setEditingContract({
                      id: editingContract.id,
                      number: editingContract.number,
                      supplier: editingContract.supplier,
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, supplier: e.target.value})}
                    placeholder="Nombre del proveedor"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditingContract({
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, value: Number(e.target.value)})}
                    min="0"
                    step="0.01"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    className="w-full border rounded px-3 py-2"
                    value={editingContract?.type || 'fixed-price'}
                    onChange={(e) => setEditingContract({
                      id: editingContract.id,
                      number: editingContract.number,
                      supplier: editingContract.supplier,
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, type: e.target.value})}
                  >
                    <option value="fixed-price">Precio Fijo</option>
                    <option value="cost-plus">Costo Más Honorarios</option>
                    <option value="time-material">Tiempo y Material</option>
                    <option value="unit-price">Precio Unitario</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditingContract({
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, status: e.target.value})}
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditingContract({
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, startDate: e.target.value})}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditingContract({
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, endDate: e.target.value})}
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) => setEditingContract({
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, scope: e.target.value})}
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) => setEditingContract({
                      ...
                      endDate: editingContract.endDate,
                      description: editingContract.description,
                      projectId: editingContract.projectId, terms: e.target.value})}
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-800">📎 Archivos Financieros</h3>
          <button
            onClick={() => setShowFileManager(!showFileManager)}
            className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 py-2 rounded-lg text-sm hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 shadow-sm hover:shadow-md"
          >
        ...
        {showFileManager && (
          <FileManager 
            projectId={currentProject?.id}
            category="financial-only"
            isContextual={true}
            title="💰 Archivos Financieros del Proyecto"
            onFileUploaded={() => {
              // Archivo financiero subido exitosamente desde gestión financiera
            }}
          />
        )}
      </div>
