...
const ResourceManagement = ({ 
  ...
  const updateNewResource = (property, value) => {
    setNewResource({
      id: newResource.id,
  ...
  const updateAssignment = (property, value) => {
    setAssignment({
  ...
  const updateEditingResource = (property, value) => {
    setEditingResource({
      ...
      projectId: editingResource.projectId,
  ...
  const handleAssignResource = () => {
    ...
    updateCurrentProjectResourceAssignments(updatedAssignments);
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-600 to-teal-700 rounded-lg p-6 text-white">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-2xl font-bold">{resourceMetrics.totalResources}</div>
            <div className="text-green-100">Recursos Totales</div>
          </div>
        </div>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateNewResource('role', e.target.value)}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateNewResource('skills', e.target.value)}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateNewResource('availability', Number(e.target.value))}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateNewResource('hourlyRate', Number(e.target.value))}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateAssignment('resourceId', e.target.value)}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateAssignment('projectId', e.target.value)}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateAssignment('allocation', Number(e.target.value))}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateAssignment('startDate', e.target.value)}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateAssignment('endDate', e.target.value)}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
              </div>
               ...
               <div className="space-y-4">
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) => updateEditingResource('name', e.target.value)}
                     className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                   />
                 </div>
                 ...
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) => updateEditingResource('role', e.target.value)}
                     className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                   />
                 </div>
                 ...
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) => updateEditingResource('skills', e.target.value)}
                     className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                   />
                 </div>
                 ...
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) => updateEditingResource('availability', Number(e.target.value))}
                     className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                   />
                 </div>
                 ...
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) => updateEditingResource('hourlyRate', Number(e.target.value))}
                     className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                   />
                 </div>
                 ...
                 <div>
                   ...
                   <select
                     ...
                     onChange={(e) => updateEditingResource('status', e.target.value)}
                     className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                   >
